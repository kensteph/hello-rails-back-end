...
# 📖 Rails back-end <a name="blog-app"></a>

A Ruby on Rails API return a random greetings via its root route or /greetings. 
...
```sh
  cd my-folder
  git clone https://github.com/kensteph/hello-rails-back-end.git
```
